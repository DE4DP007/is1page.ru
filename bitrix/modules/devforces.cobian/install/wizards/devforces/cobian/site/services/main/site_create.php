...
$site_id = "";
if (COption::GetOptionString("main", "site_cobian_create", "N") == "Y")
{
	$site_id = COption::GetOptionString("main", "site_cobian_id"); 
	...
	if (!($db_res && $res = $db_res->Fetch()))
	{
		...
		if ($result)
		{
			COption::SetOptionString("main", "site_cobian_create", "N"); 
		}
		else 
		{
