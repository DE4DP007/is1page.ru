...
class SiteSettingsStep extends CSiteSettingsWizardStep
{
	...
	function OnPostForm()
	{
		...
		if ($wizard->IsNextButtonClick())
		{
			...
			COption::SetOptionString("main", "site_landing_email", str_replace(Array("<"), Array("&lt;"), $wizard->GetVar("email")));
			...
			COption::SetOptionString("main", "site_instagram", str_replace(Array("<"), Array("&lt;"), $wizard->GetVar("instagram")));
	...
	function ShowStep()
	{
		...
		$wizard->SetVar("email", COption::GetOptionString("main", "site_landing_email", GetMessage("wiz_email"), $wizard->GetVar("siteID")));
		...
		$wizard->SetVar("instagram", COption::GetOptionString("main", "site_instagram", GetMessage("wiz_instagram"), $wizard->GetVar("siteID")));
		...
		$this->content .= $this->ShowInputField("text", "email", Array("id" => "site_landing_email", "class" => "wizard-field"))."</div>";
		...
		$this->content .= $this->ShowInputField("text", "instagram", Array("id" => "site_instagram", "class" => "wizard-field"));
